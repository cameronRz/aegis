...
2. **If no argument was given:** identify the active plan from the "Current focus" line in PLANS.md, then read that plan file (e.g. `.claude/planning/02-permission-sets.md`).
3. **If an argument was given** (e.g. `02-permission-sets`): read `.claude/planning/<argument>.md` instead.
4. Output a tight summary:
